...
VALUES
    (1, 'José', 'Silva', 'Rua Amado Batists', '123', 'Cidade Cruz do Espirito Santo', 'Espirito Santo'),
    (2, 'Ana', 'Santos', 'Rua Holistic', '456', 'Cidade Ametista', 'São Paulo');

INSERT INTO Produto (ID, IDUsuario, IDComprador, NomeProduto, TipoDispositivo, Descricao, PrecoVenda, EstoqueDisponivel)
VALUES
    (1, 1, 1, 'Celular Modelo X', 'Smartphone', 'Ótimo celular com câmera de alta qualidade.', 800.00, 10),
...
VALUES
    (1, 1, 'Cartão de Crédito', 240.00, '2023-08-02', 0.10),
    (2, 2, 'Cartão de Crédito', 700.00, '2023-08-06', 0.00);
...
--Select para filtar todos os usuários cadastrados:
